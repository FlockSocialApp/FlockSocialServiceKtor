package app.flock.social.data.table.blog
...
data class Blog(val id: Int?, val title: String,val description:String,val createdAt:String ,val updatedAt: String?, val userID: Int)

object BlogTable: Table() {
    val id=integer("id").autoIncrement().uniqueIndex()
    val blogTitle=varchar("title",1028)
    val blogDescription=varchar("description",1028)
